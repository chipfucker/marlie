...
Secrets are used to access bot tokens, users, channels, keys, and other special things.
...
Snowflake vales are automatically coerced into strings, so they can be written with or without quotes, i.e. as strings or numbers.